...
Citizen.CreateThread( function()
    ...
    while true do
        ...
        if armed then
            ...
            if not isCop and IsPedShooting(ped) and not excludedWeapons[curw] and not origin then
                local inArea = false
...
Citizen.CreateThread( function()
    ...
    while true do
        ...
        if math.random(100) > 77 and not isCop and not isInVehicle and IsPedArmed(PlayerPedId(), 7) and not IsPedArmed(PlayerPedId(), 1) and not excludedWeapons[curw] and not origin2 then
            origin2 = true
